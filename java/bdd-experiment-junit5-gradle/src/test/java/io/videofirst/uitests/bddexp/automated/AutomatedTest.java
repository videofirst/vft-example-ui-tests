        ...
        .scenarios(asList(
            ...
            VfaScenario.builder()
                ...
                .steps(asList(
                    ...
                    VfaStep.builder()
                        .type(when)
                        .name("the user types \"The Green Mile\" into search box")
                        .actions(
                    ...
                    VfaStep.builder()
                        .type(then)
                        .name("I expect to see the results page")
                        .actions(asList(
                    ...
                    VfaStep.builder()
                        .type(and)
                        .name("the top result only contains \"The Green Mile\"")
